...
public class FoodDao {
	...
	public List<String> getVertici(double k) {
		...
		try {
			...
			while(res.next()) {
				result.add(res.getString("p.portion_display_name"));
			}
	...
	public List<Arco> getArchi() {
		...
		try {
			...
			while(res.next()) {
				result.add(new Arco(res.getString("id1"), res.getString("id2"), res.getInt("peso")));
			}
